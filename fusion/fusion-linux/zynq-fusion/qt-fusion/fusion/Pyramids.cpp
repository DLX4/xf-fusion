...
using namespace cv;
// 路灯监控
#define IMG011_PATH "../images/01b.jpg"
#define IMG012_PATH "../images/01a.jpg"
// 人在山里
#define IMG11_PATH "../images/test1.bmp"
#define IMG12_PATH "../images/test2.bmp"
// 电线杆
#define IMG21_PATH "../images/left.png"
#define IMG22_PATH "../images/right.png"
// 烟雾弹 士兵
#define IMG31_PATH "../images/test31.bmp"
#define IMG32_PATH "../images/test32.bmp"
// 老照片
#define IMGTEMP1_PATH "../images/temp1.jpg"
#define IMGTEMP2_PATH "../images/temp2.jpg"
// 头像
#define AVATAR1_PATH "../images/avatar.jpg"
#define AVATAR2_PATH "../images/avatar2.jpg"

#define FLIR_00001_1 "../images/FLIR_video_00001.jpg"
#define FLIR_00001_2 "../images/FLIR_video_00001.jpeg"

#define V01 "../images/v01.bmp"
#define I01 "../images/i01.bmp"

#define V02 "../images/v02.bmp"
#define I02 "../images/i02.bmp"

#define V03 "../images/v03.bmp"
#define I03 "../images/i03.bmp"
        ...
        for (int j = 0; j < width; j++)
        {
            ...
            if ((i > 1) && (i < (height - 2)) && (j > 1) && (j < (width - 2)))
            {
                ...
                if (imageA.channels() == 1)
                {
                    ...
                    if (std::isnan(matchDegree[0]) || matchDegree[0] < matchDegreeLimit)
                    {
                        if (deltaA[0] == deltaB[0])
                        {
                            imageS.at<uchar>(i, j) = 0.5 * imageA.at<uchar>(i, j) + 0.5 * imageB.at<uchar>(i, j);
                ...
                else
                {
                    ...
                    for (int rgb = 0; rgb < 3; rgb++)
                    {
                        ...
                        if (std::isnan(matchDegree[rgb]) || matchDegree[rgb] < matchDegreeLimit)
                        {
                            if (deltaA[rgb] == deltaB[rgb])
                            {
                                imageS.at<Vec3b>(i, j)[rgb] = 0.5 * imageA.at<Vec3b>(i, j)[rgb] + 0.5 * imageB.at<Vec3b>(i, j)[rgb];
